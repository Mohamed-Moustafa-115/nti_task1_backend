...
import { createSubcategory, deleteSubcategory, filterData, getSubcategories, getSubcategory, setCategoryId, updateSubcategory } from "../controllers/subCategoriesController";
