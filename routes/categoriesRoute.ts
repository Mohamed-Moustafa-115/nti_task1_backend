...
import { createCategory, deleteCategory, getCategories, getCategory, resizeCategoryImage, updateCategory, uploadCategoryImage } from "../controllers/categoriesController";
