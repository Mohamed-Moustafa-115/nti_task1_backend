...
export const createUser = createOne<UsersInterface>(usersModel)
export const getUsers = getAll<UsersInterface>(usersModel, 'users')
export const getUser = getOne<UsersInterface>(usersModel)
...
export const deleteUser = deleteOne<UsersInterface>(usersModel)
